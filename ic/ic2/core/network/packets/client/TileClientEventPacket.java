...
/*    */   
/*    */   public TileClientEventPacket(TileEntity par1, int par2) {
...
/* 56 */     if (world == null)
/*    */     {
/* 58 */       throw new RuntimeException("Packet Has been sended wrong");
/*    */     }
/* 60 */     TileEntity tile = world.func_147438_o(this.x, this.y, this.z);
/* 61 */     if (!(tile instanceof INetworkClientTileEntityEventListener))
/*    */     {
/* 63 */       throw new RuntimeException("Packet was sended with Incorrect Data");
/*    */     }
/* 65 */     ((INetworkClientTileEntityEventListener)tile).onNetworkEvent(par1, this.eventID);
/*    */   }
/*    */ }


/* Location:              C:\Users\KABALEP\Desktop\мусор\IC2Classic-1.7.10-1.2.4.jar!\ic2\core\network\packets\client\TileClientEventPacket.class
