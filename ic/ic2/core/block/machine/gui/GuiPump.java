...
/* 25 */     this.name = StatCollector.func_74838_a("blockPump.name");
...
/* 38 */     this.field_146297_k.field_71446_o.func_110577_a(new ResourceLocation("ic2", "textures/guiSprites/GUIPump.png"));
...
/*    */       
/* 44 */       int l = this.container.tileEntity.energy * 14 / 200;
/* 45 */       if (l > 14)
/*    */       {
/* 47 */         l = 14;
/*    */       }
/* 49 */       func_73729_b(j + 62, k + 36 + 14 - l, 176, 14 - l, 14, l);
/*    */     } 
/* 51 */     int i1 = this.container.tileEntity.pumpCharge * 41 / 200;
/* 52 */     if (i1 > 41)
/*    */     {
/* 54 */       i1 = 41;
/*    */     }
/* 56 */     func_73729_b(j + 99, k + 61 - i1, 176, 55, 12, 5);
/* 57 */     if (i1 > 0)
/*    */     {
/* 59 */       func_73729_b(j + 99, k + 25 + 41 - i1, 176, 14, 12, i1);
/*    */     }
/* 61 */     func_73729_b(j + 98, k + 19, 188, 14, 13, 47);
/*    */   }
/*    */ }


/* Location:              C:\Users\KABALEP\Desktop\мусор\IC2Classic-1.7.10-1.2.4.jar!\ic2\core\block\machine\gui\GuiPump.class
