...
/*    */   public String inv;
/*    */   
/*    */   public GuiCompacting(ContainerAdvancedMachine container) {
/* 19 */     super((Container)container);
/* 20 */     this.container = container;
/* 21 */     this.name = StatCollector.func_74838_a("blockCompacting.name");
/* 22 */     this.heatLabel = StatCollector.func_74838_a("container.Compacting.speed.name");
...
/* 38 */     this.field_146297_k.field_71446_o.func_110577_a(new ResourceLocation("ic2", "textures/guiSprites/GuiCompacting.png"));
...
/*    */     {
/*    */       
/* 46 */       func_73729_b(j + 56, k + 36 + 14 - l, 176, 14 - l, 14, l);
/*    */     }
/* 48 */     int i1 = (int)(this.container.machine.getProgress() * 24.0F);
/* 49 */     func_73729_b(j + 80, k + 34, 176, 14, i1 + 1, 16);
/*    */   }
/*    */ }


/* Location:              C:\Users\KABALEP\Desktop\мусор\IC2Classic-1.7.10-1.2.4.jar!\ic2\core\block\machine\gui\GuiCompacting.class
