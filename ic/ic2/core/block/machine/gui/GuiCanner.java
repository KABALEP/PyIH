...
/* 24 */     this.name = StatCollector.func_74838_a("blockCanner.name");
...
/* 37 */     this.field_146297_k.field_71446_o.func_110577_a(new ResourceLocation("ic2", "textures/guiSprites/GUICanner.png"));
...
/* 41 */     if (this.container.tileEntity.energy > 0) {
/*    */       
/* 43 */       int l = this.container.tileEntity.gaugeFuelScaled(14);
/* 44 */       func_73729_b(j + 31, k + 27 + 14 - l, 176, 14 - l, 14, l);
/*    */     } 
/* 46 */     int i1 = this.container.tileEntity.gaugeProgressScaled(34);
/* 47 */     func_73729_b(j + 74, k + 36, 176, 15, i1, 13);
/*    */   }
/*    */ }


/* Location:              C:\Users\KABALEP\Desktop\мусор\IC2Classic-1.7.10-1.2.4.jar!\ic2\core\block\machine\gui\GuiCanner.class
