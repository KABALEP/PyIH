...
/*    */   public String inv;
/*    */   
/*    */   public GuiSingularity(ContainerAdvancedMachine container) {
/* 20 */     super((Container)container);
/* 21 */     this.container = container;
/* 22 */     this.name = StatCollector.func_74838_a("blockSingularity.name");
/* 23 */     this.heatLabel = StatCollector.func_74838_a("container.singularity.pressure.name");
...
/* 31 */     this.field_146289_q.func_78276_b(this.heatLabel, 5, 36, 4210752);
/* 32 */     int heat = (int)(this.container.machine.getSpeedLevel() * 100.0F);
/* 33 */     this.field_146289_q.func_78276_b("" + heat + "%", 5, 44, 4210752);
/*    */   }
/*    */ 
/*    */   
/*    */   protected void func_146976_a(float f, int x, int y) {
/* 38 */     GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
/* 39 */     this.field_146297_k.field_71446_o.func_110577_a(new ResourceLocation("ic2", "textures/guiSprites/GUISingularity.png"));
...
/*    */     {
/*    */       
/* 47 */       func_73729_b(j + 56, k + 36 + 14 - l, 176, 14 - l, 14, l);
/*    */     }
/* 49 */     int i1 = (int)(this.container.machine.getProgress() * 24.0F);
/* 50 */     func_73729_b(j + 79, k + 34, 176, 14, i1 + 1, 16);
/*    */   }
/*    */ }


/* Location:              C:\Users\KABALEP\Desktop\мусор\IC2Classic-1.7.10-1.2.4.jar!\ic2\core\block\machine\gui\GuiSingularity.class
